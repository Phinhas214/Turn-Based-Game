...
///
/// Setup:
///   1. Add this component to your portrait Image GameObject in the HUD.
///   2. Assign the Image component to 'portraitImage' (or leave empty — auto-found).
///   3. Fill 'portraits' in the same order as your character buttons in MainMenuController.
///      e.g. index 0 = Knight portrait, index 1 = Rogue portrait, etc.
///   No ScriptableObject required.
/// </summary>
